...
public class STickRecord implements BaseResponseRecord {
    ...
    public STickRecord(Double ask, Double bid, String symbol, long timestamp, long volume) {
        this.ask = ask;
        this.bid = bid;
        this.symbol = symbol;
    ...
    public static STickRecord create(Double ask, Double bid, String symbol, long timestamp, long volume) {
        return new STickRecord(ask, bid, symbol, timestamp, volume);
    }
