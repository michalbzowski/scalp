...
import pro.xstore.api.streaming.*;
...
public class StreamingConnector extends Connector {
	...
	public void subscribeTickPrices(String symbol) throws APICommunicationException {
		TickPricesSubscribe tickPricesSubscribe = new TickPricesSubscribe(symbol, streamSessionId);
		writeMessageToStream(tickPricesSubscribe.toJSONString());
	}

	public void unsubscribeTickPrices(String symbol) throws APICommunicationException {
		TickPricesStop tickPricesStop = new TickPricesStop(symbol);
		writeMessageToStream(tickPricesStop.toJSONString());
	}
